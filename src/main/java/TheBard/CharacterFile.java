...
import TheBard.cards.Defend;
import TheBard.cards.Strike;
import TheBard.relics.TodoItem;

import java.util.ArrayList;

import static TheBard.CharacterFile.Enums.TODO_COLOR;
import static TheBard.ModFile.*;

public class CharacterFile extends CustomPlayer {

    static final String ID = makeID("TheBard");
